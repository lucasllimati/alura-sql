...
SELECT RAND() AS [Numero Aleatorio]

--- VALOR MINIMO SEJA 100
--- VALOR MÁXIMO SEJA 500

SELECT ROUND(((500 - 100 - 1) * RAND() + 100), 0) AS [Numero Aleatorio]

-- Erro: Não pode ter o round em uma Function, mas sim, na view.
...
SELECT [dbo].[NumeroAleatorio](1,100)  AS [Numero Aleatorio]