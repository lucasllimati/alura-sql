-- Acrescentando a entidade PRODUTOS na SP

/*
Crie uma segunda stored procedure chamada BuscaPorEntidadesCompleta com o mesmo código da de cima, mas acrescente a entidade PRODUTOS.
